...
Route::get('/get-institutions/{degrees}', [EducationController::class, 'getInstitutions']);
...
Route::post('/email/resend', [LoginController::class, 'resend'])->middleware('auth')->name('verification.resend');
